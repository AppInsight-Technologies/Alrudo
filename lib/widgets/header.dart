            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  SvgPicture.asset(Images.logoAppbarImg, width: 35, height: 35/*,color: Colors.white,*/),
                  Spacer(),
                  SizedBox(
                    width: 10,
                  ),
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      ...
                      child: Image.asset(Images.pickup_point, height:25, width: 25, color: ColorCodes.whiteColor)/*Icon(Icons.location_on,
